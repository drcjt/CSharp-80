namespace MultiDim.ConstructedTypes
{
    ...
    {
        public GenericWrapper<int>[,,] GenArray = new GenericWrapper<int>[10, 10, 10];
    }
        ...
        public static int Main()
        {
            ...
            for (i = 0; (i < size); i++)
            {
                for (j = 0; (j < size); j++)
                {
                    for (k = 0; (k < size); k++)
                    {
                        ArrayHolderInst.GenArray[i, j, k] = new GenericWrapper<int>(locationNumber);
                        locationNumber++;
                    }
                }
            }
            ...
            for (i = 0; (i < size); i++)
            {
                for (j = 0; (j < size); j++)
                {
                    for (k = 0; (k < size); k++)
                    {
                        sum += ArrayHolderInst.GenArray[i, j, k].Field;
                        locationNumber++;
                    }
                }
            }
