...
%solutiondir%\ILCompiler\%outdir%\ILCompiler.exe --ignoreUnknownCil false --printReturnCode false --integrationTests true --corelibPath %solutiondir%\System.Private.CoreLib\bin\Debug\net6.0\System.Private.CoreLib.dll --outputFile %outdir%\il_bvt\%%~nF.asm .\il_bvt\%%~nF.exe
