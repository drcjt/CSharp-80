...
%solutiondir%\ILCompiler\%outdir%\ILCompiler.exe --ignoreUnknownCil --printReturnCode false --integrationTests true --corelibPath %solutiondir%\cs80corlib\bin\Debug\net5.0\cs80corlib.dll --outputFile %outdir%\il_bvt\%%~nF.asm .\il_bvt\%%~nF.exe
