...
namespace MDArrays.@byte
{
    ...
    internal static class DataTypesByte
    {
        ...
        public static int Main()
        {
            ...
            int result = ByteTests(vt1, cl1);
            if (result != 0) return result;

            result = ByteToBoolTests(vt1, cl1);
            if (result != 0) return result;
        ...
        {
            const int ByteToBoolErrorBase = 200;
        ...
        {
            const int ByteToInt32ErrorBase = 300;
        ...
        {
            const int ByteToSByteErrorBase = 400;
        ...
        {
            const int ByteToInt16ErrorBase = 500;
        ...
        {
            const int ByteToUInt32ErrorBase = 600;
        ...
        {
            const int ByteToUInt16ErrorBase = 700;
        ...
        {
            const int ByteToCharErrorBase = 800;
